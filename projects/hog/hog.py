...
def swine_align(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 4a
    d = min(player_score,opponent_score)
    while d > 1:
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0,score1):
        ...
        new_high = current_score - last_score
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    """
    # BEGIN PROBLEM 9
    n,m,highest_aveg = 1,1,0
    aveg_func = make_averaged(roll_dice, trials_count)
    while n <= 10:
        aveg_value = aveg_func(n, dice)
        if aveg_value > highest_aveg:
            m = n
            highest_aveg = aveg_value
        n += 1
    return m
    # END PROBLEM 9
